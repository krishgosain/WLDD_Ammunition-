...
//
// The payload's own `vertexShader` / `fragmentShader` template literals are
// backslash-escaped below. Unescaped they close this template literal early and
// the file does not parse. The escapes are JS-level only: the emitted HTML is
